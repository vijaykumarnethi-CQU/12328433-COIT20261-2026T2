...
![Host1-configuration](images/Host1-congiguration)

### Host 2 Configuration

I also configured Host 2 directly using **GNS3 Configure interface**

![Host2-configuration](images/Host2-congiguration)
...
```
![Host3-configuration](images/Host3-congiguration)
...
```
![Host4-configuration](images/Host4-congiguration)
